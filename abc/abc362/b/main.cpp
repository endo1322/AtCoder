...
signed main() {
    ...
    int a = pow(XY[1].first - XY[0].first, 2) + pow(XY[1].second - XY[0].second, 2);
    int b = pow(XY[2].first - XY[1].first, 2) + pow(XY[2].second - XY[1].second, 2);
    int c = pow(XY[0].first - XY[2].first, 2) + pow(XY[0].second - XY[2].second, 2);
